...
print("\n Phase-3 RL | STOCHASTIC STRONG | RESUME SAFE ")

# =========================
# CONFIG (DO NOT CHANGE ACTION SPACE)
# =========================
DT = 0.15
BASE_SPEED = 2.5
MAX_STEPS = 200

REMAINING_TIMESTEPS = 35_000      # remaining after crash
AUTOSAVE_EVERY = 10_000

MODEL_START = "phase3_stochastic_strong_xy_265224_steps.zip"
AUTOSAVE_DIR = "./autosaves_strong_resume"
CSV_LOG = "phase3_training_sensor_log_strong.csv"
...
class AirSimDroneEnv(gym.Env):
    ...
    def reset(self):
        ...
        try:
            ...
            raise RuntimeError("❌ Unreal / RPC not responding")
...
checkpoint = CheckpointCallback(
    ...
    name_prefix="phase3_stochastic_strong_resume"
)
...
model.save("phase3_stochastic_strong_final_100k")

env.close()

print("\n Phase-3 STOCHASTIC STRONG — RESUME COMPLETE")
