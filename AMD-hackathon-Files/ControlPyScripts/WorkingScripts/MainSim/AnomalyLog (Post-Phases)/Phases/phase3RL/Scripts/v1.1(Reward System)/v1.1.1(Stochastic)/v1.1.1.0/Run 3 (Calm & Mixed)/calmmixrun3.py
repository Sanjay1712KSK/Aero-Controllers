...
print("\nPhase-3 RL | STOCHASTIC CALM + MIXED | FINAL CONTINUE\n")
...
CURRENT_STEPS = 555272
REMAINING_TIMESTEPS = TARGET_TOTAL_STEPS - CURRENT_STEPS

MODEL_START = "phase3_calm_mixed_continue_555272_steps.zip"
...
class AirSimDroneEnv(gym.Env):
    ...
    def reset(self):
        ...
        print(f"\nEPISODE {self.global_episode} | FINAL RUN")
...
model = PPO.load(MODEL_START, env=env, device="cuda")
...
print(f"\nContinuing FINAL {REMAINING_TIMESTEPS} steps...\n")
...
print("\nPhase 3 STOCHASTIC CALM + MIXED — 600K COMPLETE\n")